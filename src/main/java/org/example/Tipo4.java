...
public class Tipo4 extends Medicamento {
    private Double descuento = 0.010;

    public Tipo4(String nombre, Double precio, String fabricante, String invima, LocalDate fechaVencimiento, LocalDate fechaCreacion, Double cantidad) {
